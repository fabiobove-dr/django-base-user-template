...
def password_change(request):
    ...
    return render(request, "user_manager/password_reset_confirm.html", {"form": form})
...
def password_reset_request(request):
        ...
        if form.is_valid():
            ...
            if associated_user:
                ...
                message = render_to_string(
                    "user_manager/template_reset_password.html",
                    {
    ...
    return render(
        request=request,
        template_name="user_manager/password_reset.html",
        context={"form": form},
    )
...
def passwordResetConfirm(request, uidb64, token):
    ...
    if user is not None and account_activation_token.check_token(user, token):
        ...
        form = SetPasswordForm(user)
        return render(
            request, "user_manager/password_reset_confirm.html", {"form": form}
        )
    else:
...
def activateEmail(request, user, to_email):
    ...
    message = render_to_string(
        "user_manager/template_activate_account.html",
        {
            "user": user.username,
            "domain": get_current_site(request).domain,
...
def custom_login(request):
    ...
    return render(
        request=request, template_name="user_manager/login.html", context={"form": form}
    )
...
def profile_settings(request, username):
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            return redirect("profile_settigns", user_form.username)
    ...
    if user:
        ...
        return render(
            request, "user_manager/profile_settings.html", context={"form": form}
        )
